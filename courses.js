...
const courses = [
  {
    ...
    nameEn: "English",
    nameAr: "الإنجليزية",
    subtitleEn: "Group A · Morning",
    subtitleAr: "المجموعة أ · صباحي",
  ...
  },
  {
    ...
    nameEn: "English",
    nameAr: "الإنجليزية",
    subtitleEn: "Group B · Evening",
    subtitleAr: "المجموعة ب · مسائي",
    descEn: "Master English for work, travel, and academic goals. IELTS preparation available.",
    descAr: "أتقن الإنجليزية للعمل والسفر والأهداف الأكاديمية. تحضير IELTS متاح.",
    levels: ["Beginner", "Intermediate", "Advanced", "Business", "IELTS Prep"],
    levelsAr: ["مبتدئ", "متوسط", "متقدم", "أعمال", "تحضير IELTS"],
    teacher: { initials: "TK", nameEn: "Tom K.", nameAr: "توم ك.", expEn: "6 yrs exp.", expAr: "خبرة 6 سنوات", avatarColor: "#1d4ed8" },
    totalSpots: 8,
    takenSpots: 2,
    color: "blue"
  },
...
// ============================================================
const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxB9-enBPas8fSe9Gy1GWpVXyIWFKGYYcNijn3iGN0xh9wKBBAPbxO5zvQaS8ZbiDsptw/exec";
...
async function fetchSpotCounts() {
  ...
  try {
    ...
    spots.forEach(({ id, taken, total }) => {
      const course = courses.find(c => (c.id || c.nameEn.toLowerCase()) === id.toLowerCase());
